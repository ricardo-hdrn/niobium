...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1543880494;
...
fn wire__crate__api__sink_to_remote_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok =
                            crate::api::sink_to_remote(api_url, api_payload).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__start_mcp_server_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_show_form = decode_DartFn_Inputs_String_Output_opt_String_AnyhowException(
                <flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer),
            );
            let api_show_confirm = decode_DartFn_Inputs_String_Output_bool_AnyhowException(
                <flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer),
            );
            let api_show_toast = decode_DartFn_Inputs_String_Output_unit_AnyhowException(
                <flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer),
            );
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::start_mcp_server(
                            api_show_form,
                            api_show_confirm,
                            api_show_toast,
                            api_show_output,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__get_version_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__init_logging_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__start_mcp_server_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__sink_to_remote_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
