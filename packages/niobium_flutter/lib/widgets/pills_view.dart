...
class PillsView extends StatelessWidget {
  ...
  /// Wraps the title bar for platform-specific drag behavior.
  /// On desktop, pass NbDisplay.wrapDraggable. On mobile, pass identity.
  final Widget Function({required Widget child}) wrapDraggable;
  ...
  const PillsView({
    ...
    this.onPillTap,
    this.trailing,
    this.wrapDraggable = _defaultWrap,
  });

  static Widget _defaultWrap({required Widget child}) => child;
